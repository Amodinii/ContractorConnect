...
document.addEventListener('DOMContentLoaded', function() {
  document.getElementById('companies-link').addEventListener('click', fetchCompaniesData);
  document.getElementById('contractors-link').addEventListener('click', fetchContractorsData);
...
function handleNavigation() {
  ...
  const revenueAnalyticsLink = document.getElementById('revenue-analytics-link');
  ...
  const revenueAnalyticsSection = document.getElementById("revenue-analytics-section");
