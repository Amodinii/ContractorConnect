...
import { verifyToken, authorizeCompany } from "./auth.js"; // Import verifyToken and authorizeCompany middleware

const router = Router();

// Route for posting tender with file upload
router.post("/postTender", verifyToken, authorizeCompany, upload.single("tenderFile"), async (req, res) => {
  try {
